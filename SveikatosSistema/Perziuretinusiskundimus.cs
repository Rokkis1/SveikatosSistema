...
{
    public partial class Perziuretinusiskundimus : Form
    {
        public Perziuretinusiskundimus()
        {
            InitializeComponent();
        }
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    MySqlCommand cmd = new MySqlCommand(@"DELETE FROM `pateiktiskundai` WHERE (PastebėjimoNR = @PastebėjimoNR)", databaseConnection);
                    cmd.Parameters.AddWithValue("PastebėjimoNR", comboboxdata);
        ...
        public void ComboBoxPopulator()
        {
            ...
            try
            {
                ...
                databaseConnection.Open();
                MySqlCommand validatelogin = new MySqlCommand("SELECT PastebėjimoNR FROM pateiktiskundai", databaseConnection);
        ...
        private void Datagridloader()
        {
            ...
            String selectQuery = @"SELECT PastebėjimoNR, Pastebėjimas, VartotojoNR, Data  FROM pateiktiskundai";
            MySqlConnection databaseConnection = new MySqlConnection(MySQLConnetionString);
            try
            {
                databaseConnection.Open();
        ...
        private void Perziuretinusiskundimus_Load(object sender, EventArgs e)
        {
            Datagridloader();
            ComboBoxPopulator();
            fillChart();
        ...
        private void fillChart()
        {
            ...
            try
            {
                ...
                databaseConnection.Open();
                MySqlCommand validatelogin = new MySqlCommand(@"SELECT Data FROM pateiktiskundai", databaseConnection);
                MySqlDataReader reader = validatelogin.ExecuteReader();
                while (reader.Read())
                {
