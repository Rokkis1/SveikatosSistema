...
{
    public partial class Perziuretipsichinesveikata : Form
    {
        public Perziuretipsichinesveikata()
        {
            InitializeComponent();
        }
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    MySqlCommand cmd = new MySqlCommand(@"DELETE FROM `psichinesveikata` WHERE (Psichinės_sveikatosNR = @Psichinės_sveikatosNR)", databaseConnection);
                    cmd.Parameters.AddWithValue("Psichinės_sveikatosNR", comboboxdata);
        ...
        private void Datagridloader()
        {
            ...
            String selectQuery = @"SELECT Psichinės_sveikatosNR, Šiandienos_darbo_įvertinimas, Stresas, Naujienų_paveikiamumas, Miego_kokybė,Valgymo_kokybė, Savijauta, VartotojoNR, Data FROM psichinesveikata";
            MySqlConnection databaseConnection = new MySqlConnection(MySQLConnetionString);
            try
            {
                databaseConnection.Open();
        ...
        public void ComboBoxPopulator()
        {
            ...
            try
            {
                ...
                databaseConnection.Open();
                MySqlCommand validatelogin = new MySqlCommand("SELECT Psichinės_sveikatosNR FROM psichinesveikata", databaseConnection);
        ...
        private void Perziuretipsichinesveikata_Load(object sender, EventArgs e)
        {
            ComboBoxPopulator();
            Datagridloader();
            fillChart();
        ...
        private void fillChart()
        {
            ...
            try
            {
                ...
                databaseConnection.Open();
                MySqlCommand validatelogin = new MySqlCommand(@"SELECT Data FROM psichinesveikata", databaseConnection);
                MySqlDataReader reader = validatelogin.ExecuteReader();
                while (reader.Read())
                {
