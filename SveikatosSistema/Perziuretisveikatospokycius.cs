...
{
    public partial class Perziuretisveikatospokycius : Form
    {
        public Perziuretisveikatospokycius()
        {
            InitializeComponent();
        }
        private void Datagridloader()
        {
            ...
            String selectQuery = @"SELECT Sveikatos_pokyčioNR, Sveikatos_pokytis, VartotojoNR, Data FROM sveikatospokyciai";
        ...
        public void ComboBoxPopulator()
        {
            ...
            try
            {
                ...
                databaseConnection.Open();
                MySqlCommand validatelogin = new MySqlCommand("SELECT Sveikatos_pokyčioNR FROM sveikatospokyciai", databaseConnection);
        ...
        private void Perziuretisveikatospokycius_Load(object sender, EventArgs e)
        {
            Datagridloader();
            ComboBoxPopulator();
            fillChart();
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    databaseConnection.Open();
                    MySqlCommand cmd = new MySqlCommand(@"DELETE FROM `sveikatospokyciai` WHERE (Sveikatos_pokyčioNR = @Sveikatos_pokyčioNR)", databaseConnection);
                    cmd.Parameters.AddWithValue("Sveikatos_pokyčioNR", comboboxdata);
        ...
        private void fillChart()
        {
            ...
            try
            {
                ...
                databaseConnection.Open();
                MySqlCommand validatelogin = new MySqlCommand(@"SELECT Data FROM sveikatospokyciai", databaseConnection);
                MySqlDataReader reader = validatelogin.ExecuteReader();
                while (reader.Read())
                {
